    ...
    if (contactForm) {
        contactForm.addEventListener('submit', function(e) {
            ...
            inputs.forEach(function(input) {
                ...
                if (input.tagName.toLowerCase() === 'textarea' && value.length < 10) {
                    isValid = false;
                    input.classList.add('error');
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '08d3f479-22fc-48ee-b759-7a0891b6e790',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '08d3f479-22fc-48ee-b759-7a0891b6e790';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '08d3f479-22fc-48ee-b759-7a0891b6e790';
